...
test-rectangle: compile # create a rectangle with the given size and colour
	@OVERLAY_LOG_LEVEL=d dist/overlay_linux_amd64_v1/overlay rectangle --input=_test/test.jpg --point=650,100 --size=72,25 --colour=#00FF00 --fill --output=dist/overlay_linux_amd64_v1/filled.png
	@OVERLAY_LOG_LEVEL=d dist/overlay_linux_amd64_v1/overlay rectangle --input=_test/test.jpg --point=650,300 --size=72,25 --colour=#FF0000 --stroke=10 --output=dist/overlay_linux_amd64_v1/stroked.png
